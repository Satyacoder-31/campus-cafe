...
const foodItems = [
  // Breakfast
  { name: 'Poha', description: 'Flattened rice cooked with spices, onions & peas', price: 40, image: 'https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?w=500', isVeg: true, rating: 4.5, ratingCount: 120, isSpecial: true, calories: 250, ingredients: JSON.stringify(['Flattened rice', 'Onion', 'Peas', 'Mustard seeds', 'Curry leaves', 'Lemon']), addOns: JSON.stringify([{ name: 'Extra Peanuts', price: 5 }, { name: 'Sev', price: 5 }]), categoryName: 'Breakfast' },
  { name: 'Bread Omelette', description: 'Fluffy egg omelette served with toasted bread slices', price: 55, image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=500', isVeg: false, rating: 4.4, ratingCount: 98, calories: 350, ingredients: JSON.stringify(['Egg', 'Bread', 'Onion', 'Green chilli', 'Butter']), addOns: JSON.stringify([{ name: 'Extra Egg', price: 15 }, { name: 'Cheese', price: 20 }]), categoryName: 'Breakfast' },
  { name: 'Upma', description: 'Classic semolina porridge with vegetables & nuts', price: 35, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500', isVeg: true, rating: 4.2, ratingCount: 75, calories: 220, ingredients: JSON.stringify(['Semolina', 'Vegetables', 'Cashews', 'Mustard seeds', 'Curry leaves']), addOns: JSON.stringify([{ name: 'Coconut Chutney', price: 10 }]), categoryName: 'Breakfast' },

  // South Indian
  { name: 'Masala Dosa', description: 'Crispy golden dosa filled with spiced potato masala, served with sambar & chutneys', price: 70, image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=500', isVeg: true, rating: 4.8, ratingCount: 350, isSpecial: true, calories: 380, ingredients: JSON.stringify(['Rice batter', 'Potato', 'Onion', 'Mustard seeds', 'Turmeric', 'Curry leaves']), addOns: JSON.stringify([{ name: 'Extra Sambar', price: 10 }, { name: 'Butter', price: 10 }, { name: 'Ghee', price: 15 }]), categoryName: 'South Indian' },
  ...
  { name: 'Medu Vada', description: 'Crispy fried lentil donuts served with sambar & chutney', price: 45, image: 'https://images.unsplash.com/photo-1630383249896-424e482df921?w=500', isVeg: true, rating: 4.5, ratingCount: 190, calories: 320, ingredients: JSON.stringify(['Urad dal', 'Ginger', 'Green chilli', 'Curry leaves', 'Pepper']), addOns: JSON.stringify([{ name: 'Extra Chutney', price: 5 }]), categoryName: 'South Indian' },
  { name: 'Rava Dosa', description: 'Thin crispy semolina crepe with onion & green chillies', price: 65, image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=500', isVeg: true, rating: 4.4, ratingCount: 145, calories: 300, ingredients: JSON.stringify(['Semolina', 'Maida', 'Onion', 'Green chilli', 'Cumin']), addOns: JSON.stringify([{ name: 'Masala Filling', price: 15 }, { name: 'Onion Filling', price: 10 }]), categoryName: 'South Indian' },

  // North Indian
  { name: 'Paneer Roll', description: 'Soft roomali roti wrapped with spiced paneer bhurji & fresh veggies', price: 80, image: 'https://images.unsplash.com/photo-1628294895950-9805252327bc?w=500', isVeg: true, rating: 4.7, ratingCount: 210, isSpecial: true, calories: 420, ingredients: JSON.stringify(['Paneer', 'Roti', 'Onion', 'Capsicum', 'Spices', 'Chutney']), addOns: JSON.stringify([{ name: 'Extra Paneer', price: 20 }, { name: 'Extra Sauce', price: 10 }, { name: 'Cheese', price: 15 }]), categoryName: 'North Indian' },
  { name: 'Chole Bhature', description: 'Fluffy deep-fried bread with spicy chickpea curry', price: 90, image: 'https://images.unsplash.com/photo-1626132647523-66f5bf380027?w=500', isVeg: true, rating: 4.6, ratingCount: 175, calories: 580, ingredients: JSON.stringify(['Chickpeas', 'Maida', 'Onion', 'Tomato', 'Spices']), addOns: JSON.stringify([{ name: 'Extra Bhatura', price: 20 }, { name: 'Pickle', price: 5 }]), categoryName: 'North Indian' },
  ...
  { name: 'Aloo Tikki', description: 'Crispy potato patties with tangy chutneys & curd', price: 45, image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=500', isVeg: true, rating: 4.5, ratingCount: 180, calories: 280, ingredients: JSON.stringify(['Potato', 'Spices', 'Curd', 'Chutneys']), addOns: JSON.stringify([{ name: 'Extra Tikki', price: 15 }]), categoryName: 'Snacks' },
  ...
  { name: 'French Fries', description: 'Golden crispy fries with seasoning & dipping sauce', price: 60, image: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=500', isVeg: true, rating: 4.4, ratingCount: 320, calories: 380, ingredients: JSON.stringify(['Potato', 'Salt', 'Oil']), addOns: JSON.stringify([{ name: 'Cheese Dip', price: 20 }, { name: 'Peri Peri', price: 10 }, { name: 'Schezwan', price: 10 }]), categoryName: 'Fast Food' },
  { name: 'Chicken Burger', description: 'Crispy chicken patty with coleslaw & spicy mayo', price: 110, image: 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=500', isVeg: false, rating: 4.7, ratingCount: 280, calories: 520, ingredients: JSON.stringify(['Chicken patty', 'Bun', 'Coleslaw', 'Mayo', 'Lettuce']), addOns: JSON.stringify([{ name: 'Extra Patty', price: 40 }, { name: 'Cheese', price: 20 }]), categoryName: 'Fast Food' },
  ...
  { name: 'Hakka Noodles', description: 'Stir-fried noodles with vegetables in soy & chilli sauce', price: 80, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=500', isVeg: true, rating: 4.5, ratingCount: 265, isSpecial: true, calories: 450, ingredients: JSON.stringify(['Noodles', 'Mixed vegetables', 'Soy sauce', 'Chilli sauce']), addOns: JSON.stringify([{ name: 'Extra Sauce', price: 10 }, { name: 'Paneer', price: 30 }]), categoryName: 'Chinese' },
  { name: 'Manchurian', description: 'Crispy veg balls in tangy Manchurian sauce', price: 90, image: 'https://images.unsplash.com/photo-1541832676-9b763b0239ab?w=500', isVeg: true, rating: 4.6, ratingCount: 190, calories: 380, ingredients: JSON.stringify(['Cabbage', 'Carrot', 'Sauces', 'Spring onion', 'Cornflour']), addOns: JSON.stringify([{ name: 'Dry or Gravy', price: 0 }]), categoryName: 'Chinese' },

  // Beverages
  { name: 'Masala Chai', description: 'Freshly brewed tea with ginger, cardamom & spices', price: 25, image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=500', isVeg: true, rating: 4.8, ratingCount: 680, isSpecial: true, calories: 80, ingredients: JSON.stringify(['Tea', 'Milk', 'Ginger', 'Cardamom', 'Sugar']), addOns: JSON.stringify([{ name: 'Extra Strong', price: 0 }, { name: 'Cutting Chai', price: -5 }]), categoryName: 'Beverages' },
  { name: 'Cold Coffee', description: 'Chilled blended coffee with milk & cream', price: 70, image: 'https://images.unsplash.com/photo-1517256064527-09c73fc73e38?w=500', isVeg: true, rating: 4.7, ratingCount: 340, calories: 220, ingredients: JSON.stringify(['Coffee', 'Milk', 'Cream', 'Sugar', 'Ice']), addOns: JSON.stringify([{ name: 'Extra Shot', price: 15 }, { name: 'Whipped Cream', price: 20 }, { name: 'Ice Cream Scoop', price: 30 }]), categoryName: 'Beverages' },
  { name: 'Fresh Juice', description: 'Freshly squeezed seasonal fruit juice', price: 55, image: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?w=500', isVeg: true, rating: 4.6, ratingCount: 210, calories: 130, ingredients: JSON.stringify(['Fresh fruits', 'Sugar', 'Ice']), addOns: JSON.stringify([{ name: 'No Sugar', price: 0 }, { name: 'Salt & Pepper', price: 0 }]), categoryName: 'Beverages' },
  { name: 'Lassi', description: 'Chilled thick yogurt drink — sweet or salted', price: 50, image: 'https://images.unsplash.com/photo-1553787499-6f9133860278?w=500', isVeg: true, rating: 4.7, ratingCount: 290, calories: 180, ingredients: JSON.stringify(['Curd', 'Sugar/Salt', 'Cardamom', 'Ice']), addOns: JSON.stringify([{ name: 'Mango Flavour', price: 10 }, { name: 'Rose Flavour', price: 10 }]), categoryName: 'Beverages' },

  // Desserts
  { name: 'Brownie', description: 'Warm fudgy chocolate brownie with vanilla ice cream', price: 80, image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=500', isVeg: true, rating: 4.8, ratingCount: 195, isSpecial: true, calories: 480, ingredients: JSON.stringify(['Chocolate', 'Flour', 'Butter', 'Eggs', 'Sugar', 'Vanilla']), addOns: JSON.stringify([{ name: 'Ice Cream Scoop', price: 30 }, { name: 'Extra Sauce', price: 15 }]), categoryName: 'Desserts' },
  { name: 'Gulab Jamun', description: 'Soft milk solid balls soaked in rose-flavoured syrup', price: 45, image: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=500', isVeg: true, rating: 4.7, ratingCount: 320, calories: 350, ingredients: JSON.stringify(['Khoya', 'Sugar syrup', 'Rose water', 'Cardamom']), addOns: JSON.stringify([{ name: 'With Ice Cream', price: 30 }]), categoryName: 'Desserts' },
